...
// import { Trash2 } from "lucide-react"; // Placeholder for future use
      ...
      <ScrollArea className="h-[calc(100vh-220px)] w-full rounded-md border p-4">
        {images.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full">
            <p className="text-lg text-gray-500">Uploaded images will be listed here.</p>
...
export default withAdminAuth(AdminImagesPage); // Wrap the component with the HOC
